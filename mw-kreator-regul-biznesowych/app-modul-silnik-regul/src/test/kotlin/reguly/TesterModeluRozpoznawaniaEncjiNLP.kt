...
class TesterModeluNLP {
   ...
   /* companion object {
    ...
    val przypadki = arrayListOf<PrzypadekTestowy>(
           ...
           // ,PrzypadekTestowy(58,"Jeśli data jest równa '01-02-2019' lub data nie jest równa '01-02-2019' i data nie jest mniejsza niż '01-05-2019' wtedy wyświetlaj komunikat KOMUNIKAT1 .","jest równa")
