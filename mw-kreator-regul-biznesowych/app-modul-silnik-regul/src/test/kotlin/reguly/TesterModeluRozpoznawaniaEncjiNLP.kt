...
class TesterModeluNLP {
   ...
   /* companion object {
    ...
    val przypadki = arrayListOf<PrzypadekTestowy>(
            ...
            , PrzypadekTestowy("Jeśli data jest różny od poczatek_roku oraz rok jest większy niż 2000 lub dzień jest różny od 12 to wyświetl komunikat <KOMUNIKAT_1> .","jest różny od")
